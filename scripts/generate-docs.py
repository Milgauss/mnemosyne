...
ENV_ONLY_DESCRIPTIONS = {
    ...
    "MNEMOSYNE_LLM_EXTRA_BODY": "JSON object merged last into every chat-completions request to the primary remote endpoint, for provider-specific keys the OpenAI shape has no name for (a thinking-mode toggle, provider routing). Unset, blank, invalid JSON or a non-object value means nothing is merged. Read at import.",
